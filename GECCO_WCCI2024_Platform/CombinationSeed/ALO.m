...
function [Elite_antlion_fitness,Elite_antlion_position,Convergence_curve]=ALO(N,Max_iter,lb,ub,dim,fobj,caseStudyData,otherParameters)
...
for i=1:size(antlion_position,1)
    antlions_fitness(1,i)=fobj(antlion_position(i,:),caseStudyData,otherParameters); 
end
...
while Current_iter<Max_iter+1
    ...
    for i=1:size(ant_position,1)  
        ...
        ants_fitness(1,i)=fobj(ant_position(i,:),caseStudyData,otherParameters);        

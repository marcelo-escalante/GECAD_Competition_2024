...
function [Fit_and_p,FVr_bestmemit, fitMaxVector] = ...
    HyDE(caseStudyData,otherParameters,low_habitat_limit,up_habitat_limit,sol1,sol2,sol3,sol4,sol5,sol6,fitVector)
...
deParameters.I_strategyVersion=3; %HyDE
            
deParameters.I_NP=10;
deParameters.I_itermax= floor(5000/deParameters.I_NP);%
deParameters.F_weight=0.3;
...
while gen<7  %%&&  fitIterationGap >= threshold
...
%fitMaxVector=[fitVector fitMaxVector];
fitMaxVector=fitVector;
%p1=sum(Best_otherInfo.penSlackBusFinal);
Fit_and_p=[S_bestval Fvr_bestPen]; %;p2;p3;p4]

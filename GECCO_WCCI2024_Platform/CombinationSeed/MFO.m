...
function [Best_flame_score,Best_flame_pos,Convergence_curve]=MFO(N,Max_iteration,lb,ub,dim,fobj,caseStudyData,otherParameters)
...
while Iteration<Max_iteration+1
    ...
    for i=1:size(Moth_pos,1)
        ...
        Moth_fitness(1,i)=fobj(Moth_pos(i,:),caseStudyData,otherParameters);  

...
function [gBestScore,gBest,cg_curve]=TACPSO(N,Max_iteration,lb,ub,dim,fobj,caseStudyData,otherParameters)
...
for l=1:Max_iteration
    ...
    for i=1:size(pos,1)  
        ...
        fitness=fobj(pos(i,:),caseStudyData,otherParameters);
